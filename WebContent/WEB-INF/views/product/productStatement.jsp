...
<body>
                ...
                <div class="items">
                    ...
                    <ul class="prod-list">
                    	...
                    	<li data-index="${i.cartNo}">
                    		<c:forEach items="${i.attachs}" var="a">
                    		<img class="thumb" src="${pageContext.request.contextPath}/upload/${a.prUuid}" />
                    		</c:forEach>
                    		<div class="info">
								<p class="name"><span class="prod">${i.proName}</span> <span class="num">${i.proAmt}</span>개</p>
                            	<p class="stmt"><span class="cup">${i.cupSize}</span></p>
                            	<p class="price"><strong>${i.proPrice}</strong>원</p>                    		
                    		</div>
                        </li>
                        </c:forEach>
                    </ul>
                        ...
                        <div class="sbComponent">
                            <ul class="receipt">
                                <li>
                                    <ul>
                                    	<c:forEach items="${list}" var="i">
                                        <li><span>${i.proName} ${i.proAmt}개</span><span>${i.proPrice}원</span></li>
                                        </c:forEach>
                                    </ul>
                                </li>
                                <li>
    ...
    <script>
    	...
    	let money = 0;
    	$('.prod-list li').each(function(i, key) {
    	...
    	if((money - 3000) < 30000) {
    		...
    		$('.total').text((money + 3000).toLocaleString('ko-KR') + '원');
    	}
